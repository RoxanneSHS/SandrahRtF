...
==CVShabab~ (Laughs harshly) Let no one outside these walls hear you calling me that, Pussycat. How good to see you in times like these.~
...
==Keldo25a ~The Order is ready to strike. We may well solve those little problems by ourself.~
...
=~But since two moons dark clouds have appeared. Trade stopped. Rumours were heard that troupes were sighted on the Hornswamp fields. I send messengers to Hai 'Ulthak but they are overdue. Prelate Keldorn wants to move his Paladins north to investigate but I reject - it would be a transgression of the Neutral Zone and may really cause war with the Clans.~
...
==Belt IF ~Global("RTFShauInfo","GLOBAL",0)~THEN~The Clans have recovered an ancient palace near their dwellings and rebuilt parts of it. Even some dwarfs that helped building the bridge have moved into an ancient smithy below the palace and supply the Clans with armour and weapons.~
...
==Keldo25a~A trader, Nerkio by name, he set up his post on the pass some time ago and supplies the caravans passing through. He saw the troupes but was afraid to get near them for details.~
