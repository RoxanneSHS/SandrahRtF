...
SAY~A valid observation, <CHARNAME>, Edwin Odesseiron, last of the premier family of Thay (<PRO_HESHE> always had a weakness to state the most obvious). Edwin Odesseiron, leader of the Red Hoods and liberator of Thay. (They love such grand titles, I know they do.)~
...
==RTCandre ~I'd propose to see another acquaintance you made above before we see my beloved husband.~
...
==RTCandre~You must understand Thay and its society, please. Do not make the mistake to compare this land with the Realms of the West. Tyranny, oppression, slavery and expansion wars have been the constant in Thay's history for millennia. The upper class rules the masses.~
...
==RTCandre~Come to Sharkey's tomorrow, we will meet in the save back room of the tavern. Ask Sharkey for admission. Try to avoid Ithrash's legions in town, they probably have noticed your escape and theft by now.~
...
=~Much later my ancestors found out how to use it and the family gained much of its high status due to our support of the first Sword Coast Invasion against Westgate.~
...
==RTCandre~The portal became unusable and forgotten just like the old Bhaal temple that protected it.~
...
==RTCandre~You must...Mystra must..do something to reduce Szass Tam's daily growing magical powers.~
...
END
++~You fought a truly heroic battle, you and the red hoods.~EXTERN CVSan25J Iltdef2
