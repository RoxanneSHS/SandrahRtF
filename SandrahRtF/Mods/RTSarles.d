...
~Not really, I rather need the more distinguished knowledge of your companion. Mylady, you are obviously a woman of taste and finery, regardless of the appearance of your *bodyguards*.~
==CVSan25J~Sir Sarles, if I remember well?~
==RTSarles~The very same, mylady - you see, Jorklar, I am a reknown artist!~
...
=~So, mylady, this self-declared *artist* and sculpturer has finally delivered his *masterpiece* for my master Samas Kul, wrought from the finest and most expensive Moondust Steel - and...I cannot see any improvement on the raw material we delivered to him.~
==RTSarles~Babarian, the purity of the Moondust talks to the senses and the soul of every sensitive beholder immediately. ~
...
==CVSan25J~It is rather <CHARNAME> here, who is our expert for works of art. I trust <PRO_HIMHER> completely, you have surely read <PRO_HISHER>'s encyclopedia *Masterworks and Fakes, the art of the Sword Coast*, especially Volume Four dealing with contemporary art.~
END
...
++~The value of any art is in the eye of the beholder. The beauty of this artifact speaks for itself, it requires no Sir Sarles to enhance it.~ + Neut
